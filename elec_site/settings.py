"""
Django settings for elec_site project.
...
SECRET_KEY = 'sur3+e%^-@1t^b=$@2-n1!o+sl-95hn&a-$+7*pv*z_09ey2%#'
...
WSGI_APPLICATION = 'elec_site.wsgi.application'
